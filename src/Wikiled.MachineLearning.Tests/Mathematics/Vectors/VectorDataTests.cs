...
namespace Wikiled.MachineLearning.Tests.Mathematics.Vectors
{
    ...
    public class VectorDataTests
    {
        ...
        {
            var vector = VectorDataFactory.Instance.CreateSimple(NormalizationType.None,
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => new VectorData(new []
                {
                    new VectorCell(0, new SimpleCell("1", 1), 1),
                    new VectorCell(3, new SimpleCell("1", 1), 1)
                },
        ...
        {
            var vector1 = new VectorData(new[]
                {
                    new VectorCell(0, new SimpleCell("1", 1), 1),
                    new VectorCell(3, new SimpleCell("1", 1), 1)
                },
                                        ...
                                        0,
                                        NormalizationType.Elastic);
            var vector2 = new VectorData(new[]
                {
                    new VectorCell(0, new SimpleCell("1", 1), 1),
                    new VectorCell(3, new SimpleCell("1", 1), 1)
                },
